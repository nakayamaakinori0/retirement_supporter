...
import { partnerEncourageTexts } from '../config';
import { catImages } from '../constants/images';
      ...
      {isVisible && (
        <Animated.View
          ...
          <Balloon
            ...
            <Text 
              style={{ fontSize: 20, fontFamily: 'Papyrus' }}
              testID="encourage-text"
            >
              {encourageText}
            </Text>
          </Balloon>
